...
public class FriendsController {
	...
	public JSONMessage followCompany(@RequestParam int companyId) {
		friendsManager.followCompany(ReqUtil.getUserId(), companyId);

		return JSONMessage.success();
	}

	@RequestMapping("/unfollow/company")
	public JSONMessage unfollowCompany(@RequestParam int companyId) {
		friendsManager.unfollowCompany(ReqUtil.getUserId(), companyId);
	...
	public JSONMessage queryFollow(@RequestParam(defaultValue = "") Integer userId) {
		userId = (null == userId ? ReqUtil.getUserId() : userId);
